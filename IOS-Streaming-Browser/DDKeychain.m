...
**/
@interface DDKeychain (PrivateMethods)
...
/**
    @brief Initialize the DDKeychain
    @return id
**/
- (id)init
{
...
/**
    @brief Implement the mySetObject:forKey method, which writes attributes to the keychain
    @param id
    @param id
    @return void
**/
...
/**
    @brief Implement the myObjectForKey: method, which reads an attribute value from a dictionary
    @param id
    @return id
**/
...
/**
    @brief Reset the values in the keychain item, or create a new item if it doesn't already exist:
    @return void
**/
